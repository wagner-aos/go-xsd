...
import (
	...
	collada14 "github.com/wagner-aos/go-xsd-pkg/khronos.org/files/collada_schema_1_4_go"
	collada15 "github.com/wagner-aos/go-xsd-pkg/khronos.org/files/collada_schema_1_5_go"
)
...
func main() {
	var (
		col14DirBasePath  = udevgo.GopathSrcGithub("wagner-aos", "go-xsd", "xsd-makepkg", "tests", "xsd-test-collada", "1.4.1")
		col14MakeEmptyDoc = func() interface{} { return &Col14Doc{} }
		col15DirBasePath  = udevgo.GopathSrcGithub("wagner-aos", "go-xsd", "xsd-makepkg", "tests", "xsd-test-collada", "1.5")
