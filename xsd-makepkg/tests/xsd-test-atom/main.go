...
import (
	...
	atom "github.com/wagner-aos/go-xsd-pkg/kbcafe.com/rss/atom.xsd.xml_go"
)
...
func main() {
	var (
		entryDirBasePath  = udevgo.GopathSrcGithub("wagner-aos", "go-xsd", "xsd-makepkg", "tests", "xsd-test-atom", "entry")
		entryMakeEmptyDoc = func() interface{} { return &AtomEntryDoc{} }
		feedDirBasePath   = udevgo.GopathSrcGithub("wagner-aos", "go-xsd", "xsd-makepkg", "tests", "xsd-test-atom", "feed")
